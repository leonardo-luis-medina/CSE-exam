...
export default function NewPresetPage() {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      setAllowedCategoryIds(config.categories.map((c) => c.id));
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    const res = await fetch(`/api/exams/${examId}/presets`, {
      method: "POST",
  ...
  return (
    <div className="max-w-2xl mx-auto p-8">
      <h1 className="text-2xl font-bold mb-6">Add Preset</h1>
      ...
      <div className="mb-6">
        ...
        <input
          ...
          placeholder="e.g. 2024 Full Set, Quick Review"
      ...
      <button
        onClick={handleSave}
        disabled={saving}
        className="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 font-medium w-full disabled:opacity-50"
      >
